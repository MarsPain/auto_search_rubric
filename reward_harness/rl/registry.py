...
logger = logging.getLogger("reward_harness.rl.registry")
...
class ExperimentRegistry:
    ...
    def _manifest_path(self, training_run_id: str) -> Path:
        return self._entry_path(
            self.manifests_dir, training_run_id, field_name="training_run_id"
        )

    def _result_path(self, training_run_id: str) -> Path:
        return self._entry_path(
            self.results_dir, training_run_id, field_name="training_run_id"
        )
    ...
    def _index_path(self, training_run_id: str) -> Path:
        return self._entry_path(
            self.index_dir, training_run_id, field_name="training_run_id"
        )
    ...
    def record_manifest(
        ...
        *,
        ...
        logger.info(
            "Recorded TrainingManifest training_run_id=%s", manifest.training_run_id
        )
        return path
    ...
    def record_result(
        ...
        *,
        ...
        logger.info(
            "Recorded TrainingResultManifest training_run_id=%s", result.training_run_id
        )
        return path
