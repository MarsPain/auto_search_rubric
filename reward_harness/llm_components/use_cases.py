...
class LLMRubricInitializer(LLMComponentBase):
    ...
    def __init__(
        ...
        *,
        ...
        self._fallback_initializer = (
            fallback_initializer or HeuristicRubricInitializer()
        )
            ...
            return self._request_validated(
                ...
                parser=lambda payload: payload_to_rubric(
                    ...
                    fallback_protocol=GradingProtocol(
                        num_votes=1, allow_na=True, vote_method="majority"
                    ),
                ),
            )
    ...
    def propose(
        ...
        *,
        ...
        context = {
            ...
            "top_candidate_json": json.dumps(
                candidate_snapshot(left), ensure_ascii=False
            ),
            "runner_up_candidate_json": json.dumps(
                candidate_snapshot(right), ensure_ascii=False
            ),
            "required_fields_json": get_required_fields_json(),
        }
        ...
        *,
        ...
        context = {
            ...
            "candidate_json": json.dumps(
                candidate_snapshot(candidate), ensure_ascii=False
            ),
        ...
        def parse(payload: dict[str, Any]) -> dict[str, float | None]:
            ...
            if not isinstance(grades_payload, dict):
                raise LLMParseError(
                    "verifier payload must include an object under 'grades'"
                )
